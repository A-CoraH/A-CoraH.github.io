...
function putWordOnPage() {
  ...
  var randomY = getRandomY();
    console.log("New Location", randomX, randomY); 
...
function getRandomX() {
console.log("Getting RandomX...")
//return (500 +'px');
var tempx = (Math.floor(Math.random() * window.innerWidth));
...
// return (500 + 'px');
 var tempy = (Math.floor(Math.random() * window.innerWidth));
...
function findMatchingWord(text_input) {
    var f = document.getElementById("container").childNodes
    var i;
    for (i = 0; l < f.length; l++); {
        var element = s[i];
   ...
   //ocument.getElementById("container").innerHTML = 'text_input'
   //ist.removeChild(list.childNodes[randomWordList]);
